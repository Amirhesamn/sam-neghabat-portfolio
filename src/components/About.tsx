...
import { CountUp, Reveal, SectionHeader } from "./primitives";
        ...
        <div>
          <Reveal>
            <p className="font-display text-[1.7rem] font-semibold leading-[1.18] tracking-tight sm:text-[2.4rem]">
              ...
              <span className="text-accent"> with hierarchy, restraint,</span>{" "}
              and a stubborn belief that you should never see the machinery.
            </p>
          </Reveal>
          ...
          <Reveal delay={0.1}>
            <div className="mt-8 max-w-[52ch] space-y-4 text-muted">
              <p>
                For six years I’ve shipped production-grade SaaS — from a media
                platform serving a thousand customers to a crypto wallet where a
                dropped session is a security incident, not a ticket. I work
                remotely with teams in Milan from my desk in Tehran, and I care
                about the parts users never name: the design system that made
                the team faster, the empty state that answered a question before
                it was asked.
              </p>
              <p>
                I came up through the front end — React, Next.js, and TypeScript
                — but I think in architecture: monorepos, micro-frontends,
                performance budgets, and accessibility as a default, not a
                patch. I write components like they’re going to be read aloud,
                and I treat{" "}
                <span className="text-fg">latency as a design material.</span>
              </p>
            </div>
          </Reveal>
